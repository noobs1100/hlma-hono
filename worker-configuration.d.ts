/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 87043f2ac3a83f001c58c6a12296fac7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CORS_ORIGIN: string;
		BETTER_AUTH_DISABLE_ORIGIN_CHECK: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "CORS_ORIGIN" | "BETTER_AUTH_DISABLE_ORIGIN_CHECK">> {}
}
